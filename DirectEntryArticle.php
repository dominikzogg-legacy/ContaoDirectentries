...
class DirectEntryArticle extends Backend
{
    /**
     * prepare
     */
            ...
            if($objPages->numRows > 1)
            {
                ...
                while($objPages->next())
                {
                    ...
                    if($this->User->isAdmin || in_array($objPages->id, $this->User->pagemounts))
                    {
                        ...
                        $arrDirectEntry[$intCounter]['icons']['page']['title'] = 'article';
                ...
                $this->DirectEntries->addDirectEntry('content', 'article', $arrDirectEntry);
            }
        }
    }
}